                ...
                <div className="flex flex-col gap-8 w-full">
                    ...
                    <div className="grid grid-cols-2 gap-8">
                        ...
                        <div className="flex flex-col gap-4">
                            ...
                            <div>
                                <a href={VITE_APP_URL+"/auth"} className="px-4 py-2 border border-white text-white rounded-lg hover:bg-white hover:text-primary transition duration-500 cursor-pointer">Learn More</a>
                            </div>
                        </div>
                    </div>
                </div>
